# Xperience by Kentico Custom Widgets - Google Map
It displays map obtained from the Google maps service using Latitude,Longitude and Google API Key

# Installation

Install the [RBT.Kentico.Xperience.Custom.Widgets.GoogleMap.1.0.0](https://www.nuget.org/packages/RBT.Kentico.Xperience.Custom.Widgets.) NuGet Package to your Xperience by Kentico website (>=29.4.0 with .Net 8.0) and rebuild the project.
